...
const validPositionInfoSchema = Yup.object().shape({
  ...
  abilities: Yup.object().test('at-least-one-activity', "Llenar al menos un recuadro de descripcion de habilidades", value =>
    !!(value.machineOperationDescription || value.technicalKnowledgeDescription || value.computingEquimentKnowledge || value.programmingKnowledge || value.logicKnowledge || value.numericKnowledge || value.professionalTitle)),
...
function generateOrganizationEnrollmentDocument(values: { jobTitle: any; worktime: any; jobFunction: any; desiredActivity: any; abilities?: { machineOperationDescription: string; technicalKnowledgeDescription: string; computingEquimentKnowledge: string; programmingKnowledge: string; logicKnowledge: string; numericKnowledge: string; professionalTitle: string; }; competences: any; technicalKnowledgeDescription?: any; computingEquimentKnowledge?: any; programmingKnowledge?: any; logicKnowledge?: any; numericKnowledge?: any; }) {
  let enrollmentDocument =
  {
    ...
    habilidades_necesarias: {
      operacion_de_maquinaria: values.abilities?.machineOperationDescription == "" ? undefined : values.abilities?.machineOperationDescription,
      conocimientos_tecnicos: values.abilities?.technicalKnowledgeDescription == "" ? undefined : values.abilities?.technicalKnowledgeDescription,
      manejo_de_equipo_de_computo: values.abilities?.computingEquimentKnowledge == "" ? undefined : values.abilities?.computingEquimentKnowledge,
      programacion_u_office: values.abilities?.programmingKnowledge == "" ? undefined : values.abilities?.programmingKnowledge,
      analisis_logico: values.abilities?.logicKnowledge == "" ? undefined : values.abilities?.logicKnowledge,
      analisis_numerico: values.abilities?.numericKnowledge == "" ? undefined : values.abilities?.numericKnowledge,
      titulo_profesional: values.abilities?.professionalTitle == "" ? undefined : values.abilities?.professionalTitle
    },
